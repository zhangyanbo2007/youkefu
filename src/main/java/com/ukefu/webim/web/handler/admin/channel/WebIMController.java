...
public class WebIMController extends Handler{
    ...
    public ModelAndView saveprofile(HttpServletRequest request , @Valid CousultInvite inviteData, BindingResult result, @RequestParam(value = "dialogad", required = false) MultipartFile dialogad, @RequestParam(value = "tipusericon", required = false) MultipartFile tipusericon, @RequestParam(value = "aiicon", required = false) MultipartFile aiicon) throws IOException {
