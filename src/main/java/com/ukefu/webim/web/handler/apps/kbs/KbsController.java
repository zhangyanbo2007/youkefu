...
public class KbsController extends Handler{
    ...
    public ModelAndView save(HttpServletRequest request ,@Valid KbsTopic topic , @RequestParam(value = "files", required = false) MultipartFile[] files) throws FileNotFoundException, IOException {
